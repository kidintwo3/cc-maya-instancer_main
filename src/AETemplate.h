...
MString mel_AETemplate()
{
	MString s_aeTemplate = MString() +"//deleteUI AttrEdclonerMultiFormLayout;\r\n"
		...
		"    if ($refMeshShape[0] != \"\"){textField -edit -bgc 0.6 0.6 0.8 -tx $refMeshShape[0] \"cm_t_driverObj\";}\r\n"
		"    else{textField -edit -bgc 0.3 0.3 0.3 -tx \"none\" \"cm_t_driverObj\";}\r\n"
		...
		"	iconTextButton -style \"iconAndTextHorizontal\" -image1 \"clonerMulti_Trash.png\" -label \"Bake to Instances / Delete node\" -h 20 -w 200 -bgc 0.6 0.2 0.3 -c  (\"AE_cm_bakeObjects_doBake_instances \" + $nodeName[0] ) \"cm_b_bake_and_delete\";\r\n"
